...
const Loading = () => {
  return (
    <div className="bg-black h-screen flex flex-col items-center pt-40 space-y-8">
      ...
      <div >
        <svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#15883e] font-semibold" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
